...
public class ProfilDonate extends Fragment {
    CircleImageView profileImage;
     ImageButton editPhotoButton;
     TextView tvUsername, tvWelcome, tvName, tvMobileNo, tvEmail, tvDob, tvUserType;
     Button btnLogout;
     String username;
    Bitmap bitmap;
    Uri filepath;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_profil_donate, container, false);
