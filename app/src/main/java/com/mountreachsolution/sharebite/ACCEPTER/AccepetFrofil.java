...
import com.mountreachsolution.sharebite.LoginActivity;
...
public class AccepetFrofil extends Fragment {

    CircleImageView profileImage;
     ImageButton editPhotoButton;
     TextView tvUsername, tvWelcome, tvName, tvMobileNo, tvRegisterNo, tvDetails, tvUserType;
     Button btnLogout;
     String username;
    Bitmap bitmap;
    Uri filepath;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_accepet_frofil, container, false);
        ...
        tvRegisterNo = view.findViewById(R.id.tvRegisterNo);
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    for (int i=0;i<jsonArray.length();i++){
                        ...
                        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("donorData", Context.MODE_PRIVATE);
