...
import com.mountreachsolution.sharebite.ACCEPTER.Adpter.AdpterConfirmA;
...
public class Responce extends Fragment {
    RecyclerView rvList;
    TextView tvNoRequest;
    List<POJOAccepetRequest> pojoAccepetRequests;
    String uswername;
    AdpterConfirmA adpterConfirm;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_responce, container, false);
    ...
    private void getdata(String uswername) {
        ...
        params.put("accusername",uswername);
        client.post(urls.confirrequestA,params,new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    adpterConfirm=new AdpterConfirmA(pojoAccepetRequests,getActivity());
